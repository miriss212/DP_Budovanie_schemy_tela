...
if __name__ == "__main__":
    ...
    for e in test_epcs:
        ...
        acc_train_list, acc_test_list = train_ubal_crossval(labeled, hidden_layer=150, epochs=e, folds=2, repetitions=5,
    ...
    for i in range(len(test_epcs)):
        epoch = test_epcs[i]
        results_dict[epoch] = {'train': results_train[i], 'test': results_test[i]}

    # Save the dictionary using pickle
    with open(f'results{test_epcs}{trainingName}.pkl', 'wb') as f:
