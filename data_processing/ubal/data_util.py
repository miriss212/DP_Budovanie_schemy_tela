...
def kwta_per_bodypart(distances, k=4, hand=(6,6), farm=(6,6), continuous=False):
    parts = []
    idx1 = 0
    idx2 = hand[0]**2
    # print(idx1,",",idx2)
...
def visualize(data_pairs, no_samples=5, data_style="newdata", indeces=[]):
    ...
    plt.tight_layout()
    fig_name = "data/figures/visualize_som_data_" + data_style
...
def visualize_touch_all(data_pairs_all, data_names, num_col=7, num_row=8):
