...
def train_bal(inputDataFolder, show_graph=False):
    ...
    balResults = model.train(training, max_epoch=200)
...
if __name__ == "__main__":
    ...
    if MultiRuns:
        ...
        #just one
        #res, trainAcc, testAcc = train_bal("ubal_data/ubal_data_leyla_2/", show_graph=True)
        res, trainAcc, testAcc = train_bal("C:/Users/cidom/OneDrive/Dokumenty/mAIN1/dp_harvanova/dp_harvanova/src/ubal_data/my_data/", show_graph=True)
