...
def parse_all_datadumps():
    ...
    new_data = get_only_4complete_values(timestamp_dict)
    new_raw = json.dumps(list(new_data), sort_keys=True, indent=4)
