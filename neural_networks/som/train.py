...
"""
    ...
    f.write("\n")
    f.write('Winner differentiation of right hand: {} [train], {} [test]'.format(dw_RH_train, dw_RH_test))
    f.write("\n")
    f.write('"Winner differentiation of right forearm: {} [train], {} [test]'.format(dw_RF_train, dw_RF_test))
    f.write("\n")
