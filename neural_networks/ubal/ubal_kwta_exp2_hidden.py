...
def train_ubal_crossval(dataset, epochs, folds=5, repetitions=10, hidden_layer=100, alpha = 0.3,
...
if __name__ == "__main__":
    ...
    with open("../ubal_data/ubal_data_new/" + trainingName + suffix) as f:
        data = json.load(f)
    k = 16
    results_train = []
    results_test = []
    hidden_sizes = [100,110,120]
    for hs in hidden_sizes:
        ...
        acc_train_list, acc_test_list = train_ubal_crossval(labeled, 200, hidden_layer=hs)
