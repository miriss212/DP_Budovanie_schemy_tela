...
if __name__ == "__main__":
    ...
    leftHandSom = som_loader.load_som(11, 8, 8, "../som/trained/left_hand")
    leftForearmSom = som_loader.load_som(5, 9, 12, "../som/trained/left_forearm")
    rightHandSom = som_loader.load_som(11, 8, 8, "../som/trained/right_hand")
    rightForearmSom = som_loader.load_som(5, 9, 12, "../som/trained/right_forearm")
