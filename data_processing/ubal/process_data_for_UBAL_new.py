...
def load_process_save(dir, sub_folder, filename, rightHandSom, leftForearmSom,
                      rightHandMrf, leftHandMrf, rightForearmMrf, leftForearmMrf):
    # load data
    f = open(dir + filename)
...
if __name__ == "__main__":
    ...
    """
    default = "data/data/data_matej_touch.data"
    

    leftHandSom = loadSom(11, 10, 10, "data/trained/som/left_hand")
    leftForearmSom = loadSom(5, 10, 10, "data/trained/som/left_forearm")
    rightHandSom = loadSom(11, 10, 10, "data/trained/som/right_hand")
    rightForearmSom = loadSom(5, 10, 10, "data/trained/som/right_forearm")
    ...
    # sub_folder = "my_data"
    sub_folder = "ubal_data_matej"
    load_process_save("", sub_folder, default, rightHandSom=rightHandSom, leftForearmSom=leftForearmSom,
                       rightHandMrf=rightHandMrf, leftHandMrf=leftHandMrf,
