...
if __name__ == "__main__":
    ...
    handMrf = loadMrfSom(9, 6, 6, "data/trained/mrf/right_hand")
    ...
    forearmMrf = loadMrfSom(23,6,6, "data/trained/mrf/right_forearm")
    ...
    if Generate:
        ...
        default = "ubal_miriam"
        load_process_save("ubal_data/", default, leftHandSom, rightHandSom, leftForearmSom, rightForearmSom, rightHandMrf, leftHandMrf, forearmMrf)
